            ...
            <div className="bg-white text-gray-100 rounded-lg shadow-lg my-4">
                <div className="container max-w-4xl px-10 py-6 mx-auto rounded-lg shadow-md">
                    <div className="flex items-center justify-between">
                        ...
                        <Link rel="noopener noreferrer" href="#" className="px-2 py-1 font-bold rounded bg-violet-400 text-gray-900">Javascript</Link>
                    </div>
                    <div className="mt-3">
                        <Link rel="noopener noreferrer" href="#" className="text-2xl font-bold hover:underline text-blue-500">Nos creasse pendere crescit angelos etc</Link>
